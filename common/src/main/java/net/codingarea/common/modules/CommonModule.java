package net.codingarea.common.modules;
...
import net.codingarea.common.providers.MorphiaProvider;
...
public class CommonModule extends AbstractModule {
    ...
    public MongoClient provideMongoClient() {
        ServerAddress serverAddress = new ServerAddress(this.config.getDatabaseHost(),
                this.config.getDatabasePort());

        MongoCredential credential = MongoCredential.createCredential(this.config.getDatabaseUser(),
                this.config.getDatabaseName(), this.config.getDatabasePassword().toCharArray());
